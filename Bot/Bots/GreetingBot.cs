        ...
        private async Task GetName(ITurnContext turnContext, CancellationToken cancellationToken)
        {
            ...
            else 
            {
                if (conversationData.PromptedUserForName)
                {
                    ...
                    // Reset the flag to alloe the bot to go through the cycle again
                ...
                else 
                {
                    ...
                    await turnContext.SendActivityAsync(MessageFactory.Text($"What is your name?", userProfile.Name), cancellationToken);
